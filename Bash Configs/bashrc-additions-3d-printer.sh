...
export DEVICE_DIR_PREFIX="$(realpath ~/Other\ Stuff/Linux/Devices/Raspberry\ Pi\ 3B\ \(3D\ Printer\))"
export OD_LINUX_DIR_PREFIX="/home/$USER/OneDrive/Other Stuff/Linux"
export OD_DEVICE_DIR_PREFIX="/home/$USER/OneDrive/Other Stuff/Linux/Devices/Raspberry Pi 3B (3D Printer)"
